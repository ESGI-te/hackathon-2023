  ...
  return (
    <>
          ...
          <Stack gap="2rem">
            ...
            <Stack gap="1rem">
              <div className="time">
                ...
                {formation.duration && (
                  <Typography>{formatDuration(formation.duration)}</Typography>
                )}
              </div>
              <div className="time">
                <img className="clock" src="../../../public/icons/bar-chart.svg" />
                  <Typography>{formation.difficulty}</Typography>
              </div>
              <div className="time">
                <img className="clock" src="../../../public/icons/book.svg" />
                <Typography>{formation.nblessons}</Typography>
                <Typography> {formation.nbLessons}</Typography>
      ...
      >
        ...
        >
          <FormationEditDetailsForm formation={formation} />
        </Box>
      </Modal>
    </>
